<template>
  <b-container fluid class="bg px-0 my-0">
    <SlopSwapTopNavBar />
    <div class="farm-bg">
    ...
    <b-container fluid>
      <b-row>
        <b-col sm="6" md="6" lg="6" class="my-2">
          <div>
            <b-nav>
              ...
              <b-nav-item>
                <b-img src="~/assets/img/Avalanche.png" fluid alt="SlopSwap eXchange on Avalanche Blockchain is Coming Soon!" class="chain-logos mx-0" />
              </b-nav-item>
...
import LiquidityTokenGenerator from '~/components/LiquidityTokenGenerator.vue'

export default {
  name: 'IndexPage',
  components: { LiquidityTokenGenerator, SlopSwapTopNavBar },
  data () {
    return {
      search: null
    }
